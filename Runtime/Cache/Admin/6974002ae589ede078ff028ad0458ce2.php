      ...
      <div class="tab-content">
        ...
        <table class="table table-striped table-bordered table-hover table-condensed " id="data-table">
          <tr>
           ...
           <th  id="t-star_tower" >小号杆</th>
           <th  id="t-end_tower">大号杆</th>
           ...
           <th style="display:none" id="t-tree_danger_num">结合地形砍够保护区及保护区附近需处datail_danger_degree树木胸径范围(cm)</th>
           <th style="display:none" id="t-average_height">树木平均高度(m)</th>
           <th  id="t-detail_last_time">更新时间</th>
           <th  id="t-datail_check_person">更新人</th>
           ...
           <th  id="t-datail_check_posistion_conclusion">隐患点位置</th>
          ...
          <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
              ...
              <td style="display:none" ><?php if($v['tree_danger'] == '1'): ?>是
                ...
                <?php if($v['datail_danger_degree'] == '重大'): ?><td id="t-datail_danger_degree"><font color="red">重大</font></td>
                <?php else: ?> 
                <td id="t-datail_danger_degree"><?php echo ($v['datail_danger_degree']); ?></td><?php endif; ?>
