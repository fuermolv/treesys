        ...
        <table class="table table-striped table-bordered table-hover table-condensed " id="data-table">
          ...
          <tr>
           ...
           <td>
            ...
            <select  style="width:80%" name="datail_danger_degree" id="datail_danger_degree">
            ...
            <option value="一直无树竹" >处理后无树竹</option>
          ...
          <tr>
           ...
           <td>
            ...
            <select  style="width:80%" name="datail_check_change_conclusion" id="datail_check_change_conclusion">
           
          
            <option value ="维持不变">维持不变</option>
            <option value ="一般升重大" >一般升重大</option>
           
            <option value="不构成其他升其他">不构成其他升其他</option>
            <option value="无树竹升不构成其他">无树竹升不构成其他</option>

            <option value="其他升重大" >其他升重大</option>

            <option value="不构成其他升一般" >不构成其他升一般</option>
          

            <option value ="不构成其他升重大">不构成其他升重大</option>
            <option value ="无树竹升重大" >无树竹升重大</option>
            <option value="其他升一般" >其他升一般</option>
            <option value="无树竹升一般">无树竹升一般</option>
           <option value="无树竹升其他">无树竹升其他</option>
            <option value="重大降一般" >重大降一般</option>
            <option value="重大降其他" >重大降其他</option>
            <option value="重大降不构成其他" >重大降不构成其他</option>
            <option value="重大变处理后无树竹" >重大变处理后无树竹</option>
            <option value="一般降其他" >一般降其他</option>
            <option value="一般降不构成其他" >一般降不构成其他</option>
            <option value="一般变处理后无树竹" >一般变处理后无树竹</option>
            <option value="其他降不构成其他" >其他降不构成其他</option>
            <option value="其他变处理后无树竹" >其他变处理后无树竹</option>
            <option value="不构成其他变处理后无树竹" >不构成其他变处理后无树竹</option>
          ...
          <tr>
           ...
           <td>
            ...
            <option value ="树桩已处理">树桩已处理</option>
            <option value ="树桩未处理" >树桩未处理</option>
