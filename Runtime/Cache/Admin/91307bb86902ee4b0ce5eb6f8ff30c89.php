...
<div class="table-responsive">
  <table class="table table-striped table-bordered table-hover table-condensed " id="data-table">
     ...
     <th  id="t-record_tree_deal_plan_time" >树竹计划处理时间(周)日期</th>        
     <th id="t-record_tree_deal_time" >树竹实际处理日期</th>
     <th  id="t-record_tree_degree_change" >树竹级别变化登记</th>
     <th  id="t-record_stump_deal_plan_time">树/竹桩计划处理时间(周)日期</th>
     <th  id="t-record_stump_deal_time">树/竹桩实际处理日期</th>
     
     <th  id="t-record_stump_degree_change">树/竹桩处理过程登记</th>
    </tr>
    
    <tr>
    <td><textarea style="width:180px;" id="record_tree_deal_plan_time" name="record_tree_deal_plan_time"><?php echo ($data['record_tree_deal_plan_time']); ?></textarea> </td>
    <td><input style="width:180px;" id="record_tree_deal_time" type="text" value="<?php echo ($data['record_tree_deal_time']); ?>" name="record_tree_deal_time"></td>

    <td><input style="width:180px;" id="record_tree_degree_change" type="text" value="<?php echo ($data['record_tree_degree_change']); ?>" name="record_tree_degree_change"></td>

    <td><input style="width:180px;" id="record_stump_deal_plan_time" type="text" value="<?php echo ($data['record_stump_deal_plan_time']); ?>" name="record_stump_deal_plan_time"></td>
    <td><input style="width:180px;" id="record_stump_deal_time" type="text" value="<?php echo ($data['record_stump_deal_time']); ?>" name="record_stump_deal_time"></td>
    <td><input style="width:100px;" id="record_stump_degree_change" type="text" value="<?php echo ($data['record_stump_degree_change']); ?>" name="record_stump_degree_change"></td>
    </tr>     
</table>
     ...
     $.ajax({
          type:"POST",
           ...
           data:{
             ...
             record_tree_deal_plan_time:$("#record_tree_deal_plan_time").val(),
             record_tree_deal_time:$("#record_tree_deal_time").val(),
             record_tree_degree_change:$("#record_tree_degree_change").val(),
             record_stump_deal_plan_time:$("#record_stump_deal_plan_time").val(),
             record_stump_deal_time:$("#record_stump_deal_time").val(),
             record_stump_degree_change:$("#record_stump_degree_change").val()
             },
